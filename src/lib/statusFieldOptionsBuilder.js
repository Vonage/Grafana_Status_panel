import { StatusThresholdOptionsEditor } from 'components/StatusThresholdOptionsEditor';
export var statusFieldOptionsBuilder = function (builder) {
    return builder
        .addSelect({
        path: 'aggregation',
        name: 'Aggregation',
...
//# sourceMappingURL=statusFieldOptionsBuilder.js.map